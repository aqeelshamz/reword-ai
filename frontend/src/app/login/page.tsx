...
export default function Home() {
    ...
    return (
        <main className="w-screen h-screen bg-base-100 flex p-2">
            <div className='flex flex-col text-white p-10 max-w-[30vw] bg-primary h-full rounded-md'>
                ...
                <p className="opacity-70">Discover the power of RewordAI, the AI-powered text rewriter that can rewrite any text with a single click.</p>
            </div>
            <div className="flex flex-col w-full h-full ml-2 rounded-md p-10">
